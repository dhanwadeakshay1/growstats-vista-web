...
const HeroSection = () => {
  return (
    <section className="relative pt-20 pb-12 md:pt-32 md:pb-20 overflow-hidden bg-gradient-to-br from-growstats-50 via-white to-accent-50">
      {/* Decorative elements */}
      ...
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col items-start space-y-6 animate-fade-up">
            ...
            <div className="grid grid-cols-3 gap-4 pt-6">
              <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                <p className="font-display font-bold text-2xl text-growstats-700">98%</p>
                <p className="text-sm text-muted-foreground">Client Satisfaction</p>
              </div>
              <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                <p className="font-display font-bold text-2xl text-growstats-700">200+</p>
                <p className="text-sm text-muted-foreground">Projects Completed</p>
              </div>
              <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                <p className="font-display font-bold text-2xl text-growstats-700">10+</p>
          ...
          <div className="relative animate-fade-up">
            ...
            {/* Floating elements */}
            <div className="absolute -top-8 -right-8 bg-white p-4 rounded-xl shadow-lg hidden md:flex items-center space-x-3">
